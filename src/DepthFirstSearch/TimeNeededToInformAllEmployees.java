...
/*
 * Leetcode Practice: #1376. Time Needed to Inform All Employees
 * 
 ...
 * is the direct manager of the i-th employee, manager[headID] = -1. Also it's guaranteed
...
public class TimeNeededToInformAllEmployees {
    ...
    private static int dfs(int e_id, int[] manager, int[] informTime, Map<Integer, Integer> times) {
        if(manager[e_id] == -1) {
            return 0;
        }
