package String;
/*
 * Leetcode Practice: #788. Rotated Digits
 * 
 ...
 * and 5 rotate to each other (on this case they are rotated in a different direction, in other words 2 or 5
 * gets mirrored); 6 and 9 rotate to each other, and the rest of the numbers do not rotate to any other
